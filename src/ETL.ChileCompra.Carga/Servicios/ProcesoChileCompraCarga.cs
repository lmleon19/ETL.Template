...
public sealed class ProcesoChileCompraCarga
{
    ...
    public void RegistrarInicioProceso() => logger.LogInformation("Inicio ETL ChileCompra Carga.");

    public void RegistrarFinProceso() => logger.LogInformation("Fin ETL ChileCompra Carga.");
