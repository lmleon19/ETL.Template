...
| `Csv` | Funcional | Leer archivos CSV con encabezado, delimitador configurable, calificador de texto y campos multilinea. |
...
| `ValidadorCsv` | Funcional | Validar estructura básica y columnas obligatorias en archivos CSV, incluyendo registros multilinea. |
